...
parser.add_argument('--data', type=str, default='./texts_data',
...
parser.add_argument('--save', type=str,  default='./checkpoints/mova.pth',
...
def _run_epoch(model, data, is_train=False, lr=1.0):
...
if __name__ == "__main__":
  ...
  model = LSTMnet(embedding_dim=args.hidden_size, num_steps=args.num_steps, batch_size=args.batch_size,
  ...
  for epoch in range(args.num_epochs):
    ...
    train_p = _run_epoch(model, train_data, True, lr)
