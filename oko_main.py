...
trainset = torchvision.datasets.CIFAR10(
    root='./images_data', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(
    root='./images_data', train=False, download=True, transform=transform_test)
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        torch.save(state, './checkpoints/oko.pth')
        best_acc = acc
